...
public class CommentActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//int nType = getIntent().getIntExtra("nType", -1);
		strCommentImage = getIntent().getStringExtra("strLargeImage");

		/*if (1 == nType) {
			strCommentImage = DynamicDetailActivity.CommentMaps
					.get(nCommentsIndex + "");
		} else if (2 == nType) {
			strCommentImage = ShareDynamicDetailActivity.CommentMaps
					.get(nCommentsIndex + "");
		}*/
		// 对图片数据进行排序
